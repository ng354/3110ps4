...
TEST_UNIT = eval [] (BinOp (Plus, String "hey", Bool true)) === VError "Not a valid value"
TEST_UNIT = eval [] (BinOp (Plus, Bool false, Bool true)) === VError "Not a valid value"
TEST_UNIT = eval [] (BinOp (Plus, Int 4, Unit)) === VError "Not a valid value"
...
TEST_UNIT = eval [] (BinOp (Minus, BinOp (Plus, Bool false, Int 5), Int 1)) === VError "Not a valid value"
...
TEST_UNIT = eval [] (BinOp (Lt, String "hello", String "hello")) === VBool false
...
TEST_UNIT = eval [] (BinOp (Gt, String "goodbye", String "hello")) === VBool false

TEST_UNIT = eval [] (BinOp (Eq, Int 4, Int 6)) === VBool false
TEST_UNIT = eval [] (BinOp (Eq, Int 6, Int 6)) === VBool true
TEST_UNIT = eval [] (BinOp (Ast.Eq, String "goodbye", String "hello")) === VBool false
...
TEST_UNIT = eval [] (BinOp (LtEq, String "hello", String "hello")) === VBool true
...
TEST_UNIT = eval [] (BinOp (NotEq, Unit, Bool false)) === VError "Not a valid value"
...
TEST_UNIT = eval [] (BinOp (Concat, Int 4, Int 5)) === VError "Not a valid value"
...
TEST_UNIT = eval [] (If (BinOp (NotEq, BinOp (Times, Int 4, Int 7), Int 28), String "wrong", String "right")) === VString "right"

(* Test Var *)
let var_env = ("x", ref (VInt 5))::[]
TEST_UNIT = eval var_env (Var "x") === VInt 5
TEST_UNIT = eval [] (Let ("x", BinOp (Plus, Int 5, Int 6), BinOp (Times, Var "x", Int 8))) === VInt 88

(* Test App, assuming Fun is correct (see below) *)
TEST_UNIT = eval [] (App (Fun ("x", BinOp (Plus, Var "x", Int 1)), BinOp (Plus, Int 5, Int 7))) === VInt 13
TEST_UNIT = eval [] (Fun ("x", App (BinOp (LtEq, Var "x", Int 45), BinOp (Times, Int 9, Int 4)))) ===
                    (VClosure ("x", App (BinOp (LtEq, Var "x", Int 45), BinOp (Times, Int 9, Int 4)), []) )
TEST_UNIT = eval [] (App (Fun ("x", BinOp (LtEq, Var "x", Int 45)), BinOp (Times, Int 9, Int 4))) === VBool true
...
TEST_UNIT = eval [] (Let ("x", BinOp (Times, BinOp (Minus, Int 10, Int 5), Int 4),
